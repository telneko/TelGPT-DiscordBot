...
# noinspection PyMethodMayBeStatic,DuplicatedCode,PyUnresolvedReferences
class DiscordCommands(TelGPTCommand):
    openAIApi: OpenAIAPI
    geminiApi: GeminiAPI
    githubApi: GithubAPI
...
discordCommand: Final[DiscordCommands] = DiscordCommands()
